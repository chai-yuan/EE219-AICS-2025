...
static inline void maxpool_24_6(void *src_addr, void *dst_addr) {
    asm volatile(".insn r 0x7B, 0x0, 0x0, x0, %0, %1" : : "r"(dst_addr), "r"(src_addr));
}

static inline void relu_512_32(void *src_addr, void *dst_addr) {
    asm volatile(".insn r 0x7B, 0x1, 0x0, x0, %0, %1" : : "r"(dst_addr), "r"(src_addr));
}

static inline void relu_512_16(void *src_addr, void *dst_addr) {
